...
Artifact Server `v0.1.1` is available as `ghcr.io/ajmcclary/artifact-server:v0.1.1`. Pin a production deployment to the immutable image reference in the release asset named `image-reference.txt`.
</Aside>

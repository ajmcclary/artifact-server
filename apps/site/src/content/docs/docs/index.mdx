...
Artifact Server `v0.1.1` includes a portable Node.js package, four agent integration packages, software bills of materials, checksums, and a multi-platform container image. Each deployment page identifies the tests that its target passed.
</Aside>
